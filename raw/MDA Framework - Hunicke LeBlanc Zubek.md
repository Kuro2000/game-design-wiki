...
**Source**: `MDA Framework.pdf` — Robin Hunicke, Marc LeBlanc, Robert Zubek. GDC Workshop paper, 2004.
**Pages**: 5
...
which attempts to bridge th e gap between game design and 
development, game criticism, and technical game research. 
We believe this methodology will clarify and strengthen the 
iterative processes of develope rs, scholars and researchers 
...
each other as a whole.  D ecomposing, understanding and 
...
This requires that players ha ve adversaries (in Charades, 
teams compete, in Quake, th e player competes against 
...
team) or supplying winning c onditions that are more 
...
constructing and changing le vels or worlds, and for 
creating personalized, unique characters . Dramatic tension 
comes from dynamics that en courage a rising tension, a 
...
leader or leaders become in creasingly wealthy, they can 
penalize players with increas ing effectiveness. Poorer 
...
ability to recreate th e reality of monopoly practices  but 
reality isnt always fun. 
Mechanics 
Mechanics are the various actions, behaviors and control 
mechanisms afforded to the pl ayer within a game context. 
...
First Pass 
Consider an example Baby sitting game [Hunicke, 2004]. 
...
Hiding places could be tagge d manually, paths between 
...
with several characters at on ce. We can add time pressure 
mechanics (i.e. get them all to bed before 9 pm), include a 
mess factor or monitor charact er emotions (dirty diapers 
...
behavior, evasion and es cape. Mechanics include 
...
data. Reasoning about the pl ayers position and intent 
...
tuning. It allows us to reas on explicitly about particular 
